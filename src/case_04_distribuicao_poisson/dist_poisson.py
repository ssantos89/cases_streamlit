...
# Definindo título para página
st.set_page_config(page_title='Probabilidade de Falhass em Equipamentos')
...
# Definindo o cálculo condicional com Poisson
if processar:
    lamb = ocorrencia
    inic = lamb - 2
    fim = lamb + 2
    ...
    # Arredondando casas decimais do resultado encontrado
